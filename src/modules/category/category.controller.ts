...
const createCategory = async (req: Request, res: Response) => {
  try {
    ...
    const result = await CategoryServices.createCategory({ name, slug, thumbnail });
...
const updateCategory = async (req: Request, res: Response) => {
  try {
    ...
    const result = await CategoryServices.updateCategory(id as string, { name, slug, thumbnail } );
